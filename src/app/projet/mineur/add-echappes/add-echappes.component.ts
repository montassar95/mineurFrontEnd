...
export class AddEchappesComponent  implements OnInit, OnDestroy {
  ...
  ngOnDestroy() {
    ...
    this.crudservice.getlistEntity("commentTrouver" )
    .subscribe(data => {
      console.log(data);
      ...
      .subscribe(data => {
          ...
          .subscribe(data => {
            ...
            .subscribe(data => {
              ...
              this.crudservice.countByEnfantAndArrestation("echappes",this.arrestation.enfant.id,this.arrestation.arrestationId.numOrdinale )
              .subscribe(data => {
                console.log(data);
              ...
              this.crudservice.findByIdEnfantAndResidenceTrouverNull("echappes",this.arrestation.arrestationId.idEnfant)
              .subscribe(data => {
                ...
                if (data.result == null) { 
                  ...
                  .subscribe(data => {
                    ...
                    if (data.result == null) {
                      if( this.residence.etablissement.id != this.currentUser.personelle.etablissement.id ) 
                      { 
                      this.isShow=true;
                    ...
                    if( this.echappes.residenceEchapper.etablissement.id != this.currentUser.personelle.etablissement.id ) 
  ...
  save() {
        ...
        echappesId.numOrdinaleArrestation =   this.arrestation.arrestationId.numOrdinale; 
       
         
        this.echappes.echappesId =  echappesId;

        this.dateEchappes = this.datepipe.transform(this.dateEchappes, 'yyyy-MM-dd');
  ...
  confirmer(){
    this.crudservice.createLigne("echappes", this.echappes) 
    .subscribe(data => {
  ...
  saveTrouver() {
    ...
    if(this.memeEtablisement == true){
      ...
      this.echappes.residenceTrouver.etablissement = this.currentUser.personelle.etablissement;
