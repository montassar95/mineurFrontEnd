...
@Component({
  selector: 'app-visit-family',
  templateUrl: './visit-family.component.html',
  styleUrls: ['./visit-family.component.scss'],
   providers: [MessageService],
})
export class VisitFamilyComponent implements OnInit {
idLiberation: number;
  idMutation: number;
  idDeces: number;
  idEchappes: number;
