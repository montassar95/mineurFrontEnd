...
export class AffaireComponent implements OnInit {
  ...
  dirCarteRecup() {
    this.crudservice.getLigneById("enfant", this.idCarteRecup)
    .subscribe(data => {
      if (data.result == null) {
  ...
  dirHeber() {
    this.crudservice.getLigneById("enfant", this.idHeber)
    .subscribe(data => {
      if (data.result == null) {
  ...
  dirCarteDepot() {
    this.crudservice.getLigneById("enfant", this.idCarteDepot)
    .subscribe(data => {
      if (data.result == null) {
  ...
  dirTansfert() {
    ...
    this.crudservice.getLigneById("enfant", this.idTansfert)
    .subscribe(data => {
      if (data.result == null) {
  ...
  dirArreterLexecution() {
    ...
    this.crudservice.getLigneById("enfant", this.idArreterLexecution)
    .subscribe(data => {
      if (data.result == null) {
        ...
        window.localStorage.setItem("idValide",  this.idArreterLexecution.toString());
