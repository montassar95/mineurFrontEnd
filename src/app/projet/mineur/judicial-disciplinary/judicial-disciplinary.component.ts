...
@Component({
  selector: 'app-judicial-disciplinary',
  templateUrl: './judicial-disciplinary.component.html',
  styleUrls: ['./judicial-disciplinary.component.scss'],
      providers: [MessageService],
})
export class JudicialDisciplinaryComponent implements OnInit {
idLiberation: number;
  idMutation: number;
  idDeces: number;
  idEchappes: number;
