...
@Component({
  selector: "app-social-global",
  templateUrl: "./social-global.component.html",
  styleUrls: ["./social-global.component.scss"],
  providers: [MessageService],
})
export class SocialGlobalComponent implements OnInit {
  idLiberation: number;
  idMutation: number;
  idDeces: number;
  idEchappes: number;
