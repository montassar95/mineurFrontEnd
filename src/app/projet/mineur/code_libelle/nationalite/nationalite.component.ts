...
nationalite:Nationalite;
  ...
  showAllNationalite() {
    ...
    this.crudservice.getlistEntity("nationalite")
    .subscribe( data => {
      if(data.result){
...
addNat(){
  ...
  this.crudservice.createLigne("nationalite",   this.nationalite)
  .subscribe(data => {
    if(data.result){
  ...
  delete(nationalite: Nationalite){
    ...
    this.crudservice.deleteLigne("nationalite", nationalite.id) .subscribe(data => {
